...
#' @description
#' This function returns figure 1d in Fernandez et al.(2022): Boxplots and density plots for the
#' distribution of the b (A2) parameter of the CNDC for C3 (red color) and C4 (blue color) species
